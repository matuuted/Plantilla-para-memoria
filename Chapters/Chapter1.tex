...
Por otra parte, la disponibilidad de microcontroladores de alta capacidad, módulos de comunicación inalámbrica y sensores de precisión a precios accesibles representa una oportunidad para desarrollar soluciones tecnológicas que superen las limitaciones de los productos comerciales existentes, particularmente en lo que respecta a la incorporación de mecanismos de monitoreo del consumo real del alimento. Este aspecto resulta fundamental para satisfacer la necesidad planteada de obtener información confiable sobre los hábitos alimenticios de la mascota.
...
\begin{figure}[H]
    ...
    \caption[Dispensador automático PetSafe \textit{Smart Feed}]%
            {Dispensador automático PetSafe \textit{Smart Feed}\protect\footnotemark.}
    \label{fig:petsafe}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[Dispensador automático PETLIBRO \textit{Granary Smart Feeder}]%
            {Dispensador automático PETLIBRO \textit{Granary Smart Feeder}\protect\footnotemark.}
    \label{fig:petlibro}
\end{figure}
...
El objetivo del trabajo es desarrollar un prototipo funcional de un dispensador inteligente de alimento seco para gatos, capaz de automatizar la entrega de alimento en horarios programados, registrar el consumo real del animal mediante un sistema de pesaje y operar de forma autónoma ante cortes de conectividad o energía eléctrica. Es un dispositivo orientado a propietarios de gatos que deseen automatizar la alimentación de su mascota y obtener información confiable sobre sus hábitos de consumo. Para ello, el sistema debe satisfacer las siguientes necesidades:

\begin{itemize}
    \item Automatizar la entrega de alimento en horarios programados.
    \item Registrar el consumo real del animal mediante el pesaje del plato.
    \item Operar de forma autónoma ante cortes de conectividad o energía eléctrica.
    \item Permitir la configuración de horarios y la consulta del historial de eventos por parte del usuario.
    \item Permitir un dispensado manual mediante acción del usuario.
\end{itemize}