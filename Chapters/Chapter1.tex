...
El objetivo del trabajo fue desarrollar un prototipo funcional de un dispensador 
inteligente de alimento seco para gatos. Para ello se empleó el microcontrolador 
STM32F446RE \cite{stm32f446re_datasheet}, con el fin de automatizar la entrega 
de alimento en horarios programados, monitorear el consumo del animal mediante 
el pesaje del plato y operar de forma autónoma ante cortes de conectividad o 
energía eléctrica.
