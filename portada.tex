...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Dispensador inteligente de comida para gatos} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Matías Nahuel Durante} \\[1cm]
        ...
        \textbf{Director:} Esp. Ing. Santiago Bualó (FIUBA)} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Martin Duarte (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Santiago Escribá (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Lucas Monzón Languasco (FIUBA)} \\[2cm]

        % Fecha y lugar
        {\fontfamily{phv}\itshape\fontsize{10pt}{12pt}\selectfont
        Ciudad de Córdoba, agosto de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
